                        ...
                        <div className="support-accordion">
                            <Accordion
                                ...
                                items={[
                                    {
                                        id: 0,
                                        title: "1. How is cryptocase different from companies like CoinDCX and WazirX?",
                                        description:
                                            "<p>We are not a crypto exchange, but a platform built on top of CoinDCX, Binance and WazirX which are leading crypto exchanges. Once you sign in and complete your verification, all your trades are executed by us on these exchanges.</p>",
                                    },
                                    {
                                        id: 1,
                                        title: "2. What things are taken into account while making Cryptocases?",
                                        description:
                                            "<p>We take into account a lot of factors while designing cryptocases. Our main goal is to optimise Risk and Upside Potential of crypto. We build cryptocases around themes and technologies also.</p>",
                                    },
                                    {
                                        id: 2,
                                        title: "3. Where are these investments being made?",
                                        description:
                                            "<p>All your investments are being made on CoinDCX and Binance exchange through our APIs. The funds are stored in the Cryptocase wallet on CoinDCX/ Binance.</p>",
                                    },
                                    {
                                        id: 3,
                                        title: "4. Who is the team?",
                                        description:
                                            "<p> We are all students of BITS Pilani who love the Web 3 Ecosystem.</p><p> Shrish does Technical Analysis and has managed funds of upwards of 20 Lakhs INR.</p><p> Daksh has done Product Management at a YC startup and has analysed multiple crypto projects fundamentally.</p>",
                                    },
                                ]}
                            />
                        </div>
                    ...
                    <div className="support-accordion">
                        ...
                        <div className="read-card">
                            <div className="content">
                                <p>
                                    Invest in cryptocurrency now & start your
                                    crypto journey today.{" "}
                                    <a href="https://play.google.com/store/apps/details?id=app.cryptocase.cryptocase">
                                        Download the app
                                    </a>{" "}
                                    now!
                                </p>
